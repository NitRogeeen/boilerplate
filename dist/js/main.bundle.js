...
var Main = function () {
    ...
    _createClass(Main, [{
        key: 'getLoadUrl',
        value: function getLoadUrl(rootPath) {
            return url__WEBPACK_IMPORTED_MODULE_2___default.a.format({
                protocol: 'file',
                pathname: path__WEBPACK_IMPORTED_MODULE_1___default.a.join(path__WEBPACK_IMPORTED_MODULE_1___default.a.resolve(rootPath), 'index.html'),
                slashes: true
            });
        }
        ...
        key: 'windowAllClosed',
        value: function windowAllClosed() {
